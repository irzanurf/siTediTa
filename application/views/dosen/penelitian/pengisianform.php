...
<div class="form-group"> Form ini memanfaatkan teknik OCR, silahkan input file proporsal terlebih dahulu :<br>
						<label for="exampleInputFile"><strong>Upload Proposal</strong></label><label style="color:red; font-size:12px;">&nbsp;(*Wajib diisi)</label><br> 
						<input type="file" name="file_prop" class="form-control" accept="application/pdf" id="file"> <br>
								...
								<div class="form-body">
                                    ...
                                    <select class="form-control" name="jenis" id="jenis" required="">
										...
										<div class="form-group"> 
											...
											<textarea name="abstrak" rows="4" class="form-control" id="input_abstrak" required=""> </textarea>
										</div> 
										<div class="form-group"> 
											<label">Lokasi</label> 
											<input name="lokasi" class="form-control" id="input_lokasi" placeholder="Kelurahan, Kota, Provinsi"> 
										</div> 
										<div class="form-group"> 
											<label>Mitra</label> 
											<input name="mitra" class="form-control" id="input_mitra"> 
                                        </div> 
                                        <div class="form-group"> 
...
$(document).ready(function (e) {
 // $("#file").on('change',(function(e) {
  ...
  $.ajax({
    url: '<?= base_url("ocr/Hasilpenelitian"); ?>',
    data: fd,
    processData: false,
    contentType: false,
    type: 'POST',
