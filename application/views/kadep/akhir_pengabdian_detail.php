						...
						<div class="forms">
							...
							<h4>Luaran</h4>
											...
											<div class="form-group">
                                    			...
                                    			<textarea readonly class="form-control" style="background: #edf1f5;" rows="2" value="" name=<?="judul".$i."" ?> ><?= $luaran[$i]->judul?></textarea>
                                			</div>
											<div class="form-group">
                                    			<label>Nama Jurnal/Artikel/Modul/Draft/Blueprint/Metode</label>
                                    			<textarea readonly class="form-control" style="background: #edf1f5;" rows="2" value="" name=<?="nama".$i."" ?> ><?= $luaran[$i]->nama?></textarea>
                                			</div>
											<div class="form-group">
                                    			<label>Author</label><label style="color:red; font-size:12px;"> (*Wajib diisi)</label>
                                    			<textarea readonly class="form-control" style="background: #edf1f5;" rows="2" value="" name=<?="author".$i."" ?> ><?= $luaran[$i]->author?></textarea>
                                			</div>
											<div class="form-group">
                                    			<label>Tahun</label><label style="color:red; font-size:12px;"> (*Wajib diisi)</label>
                                    			<input class="form-control" type="number" style="background: #edf1f5;" value="<?= $luaran[$i]->tahun?>" name=<?="tahun".$i."" ?> readonly></input>
                                			</div>
											<div class="form-group">
                                    			<label>Link</label>
                                    			<input class="form-control" style="background: #edf1f5;" value="<?= $luaran[$i]->link?>" name=<?="link".$i."" ?> readonly></input>
                                			</div>
                                            <div class="form-group">
                                                <label>Jumlah Sitasi</label>
                                                <input class="form-control" type="number" style="background: #edf1f5;" value="<?= $luaran[$i]->sitasi?>" name=<?="sitasi".$i."" ?> readonly></input>
                                            </div>
											<div class="form-group"> 
											...
											<iframe src="<?= base_url('assets/luaran');?>/<?=$luaran[$i]->file?>" width="100%" height="400px" >
                                                ...
                                                echo "<label>File belum diunggah</label>";
                                            }?>
											</div>
                            ...
                            <div class="form-group"> 
											<label>Catatan</label> 
											<textarea readonly name="catatan" rows="4" class="form-control"> </textarea>
							</div> 
