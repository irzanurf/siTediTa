    ...
    <div class="row">
        ...
        <table class="table">
            ...
            <tr>
                ...
                <form style="display:inline-block;" method="post" action="<?= base_url('kadep/kadep/setReviewerPenelitian') ;?>/<?= $v->id; ?>">
                ...
                <form style="display:inline-block;" method="post" action="<?= base_url('kadep/kadep/EditReviewerPenelitian') ;?>/<?= $v->id; ?>">
                                    <input type='hidden' name="jadwal" value=<?=$jadwal?>>
                                    <button type="Submit" class="btn btn-info">
                                    Edit reviewer
                                    </button>
