...
<div class="card"><div class="card-body">
              <div class="row">
              <div class="col-sm-3">
          <form action="<?= base_url('publikasi/Umum/cariGaruda_pengabdian');?>" method="post">
                                ...
                                <td>
                                    ...
                                    <dl align="left" class="uk-description-list-line">
                                        <dt class="uk-text-primary">
                                           <a href="" > <?php echo $i->Title; ?></a>
                                        </dt>
                                        <dd> <?php echo $i->Author; ?></dd>
                                         <dd> <?php echo $i->Detail; ?></dd>
                                         <dd> <?php echo $i->Date_Released; ?></dd>
                                      </dl>
