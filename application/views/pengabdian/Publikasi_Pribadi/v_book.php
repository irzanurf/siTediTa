...
<div class="card"><div class="card-body">
              <div class="row">
              <div class="col-sm-3">
          <form action="<?= base_url('publikasi/Pribadi/cariBook_pengabdian');?>" method="post">
                                ...
                                <td>
                                    ...
                                    <dl align="left"  class="uk-description-list-line">
                                        <dt class="uk-text-primary">
                                         ...
                                         <dd> <?php echo "ISBN : ",$i->Isbn; ?></dd>
                                          <dd> <?php echo "Author : ",$i->Author; ?></dd>
                                          <dd> <?php echo "Publisher : ",$i->Publisher; ?></dd>
                                          <dd> <?php echo $i->pld; ?></dd>
                                      </dl>
