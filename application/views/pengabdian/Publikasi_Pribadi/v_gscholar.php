...
<div class="card"><div class="card-body">
              <div class="row">
              <div class="col-sm-3">
          <form action="<?= base_url('publikasi/Pribadi/cariGscholar_pengabdian');?>" method="post">
                                ...
                                <td>
                                    ...
                                    <dl align="left" class="uk-description-list-line">
                                        <dt class="uk-text-primary">
                                           <a href="<?php echo $i->Link_Judul; ?>" > <?php echo $i->Judul; ?></a>
                                        </dt>
                                        <dd> <?php echo $i->Author; ?></dd>
                                         <dd> <?php echo $i->Index_By; ?></dd>
                                      </dl>
