                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <!-- <li> <a class="waves-effect waves-dark" href="<?= base_url('reviewer/penelitian/penilaian_penelitian/');?>" aria-expanded="false"><i style="color:white"
                                    ...
                                    <ul id="demo" class="collapse">
                                    <li>
                                    <a href="<?= base_url('publikasi/Pribadi/overview_penelitian');?>"><h5 style="color:white;">Pribadi</h5></a>
                                </li>
                                <li>
                                    <a href="<?= base_url('publikasi/Umum/dashboard_penelitian');?>"><h5 style="color:white;">Umum</h5></a>
                                </li>
                        </ul></li><?php }else { ?>
                            <li> <a class="waves-effect waves-dark" href="<?= base_url('publikasi/Umum/dashboard_penelitian');?>" aria-expanded="false"><i style="color:white"
